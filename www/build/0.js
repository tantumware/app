webpackJsonp([0],Array(306).concat([
/* 306 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_components_module__ = __webpack_require__(315);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__statistics__ = __webpack_require__(460);
...
StatisticsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__statistics__["a" /* StatisticsPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__statistics__["a" /* StatisticsPage */]),
...
/* MIT license */
var cssKeywords = __webpack_require__(327);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_chart_js__ = __webpack_require__(461);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_chart_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_chart_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_estatistica_estatistica__ = __webpack_require__(216);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StatisticsPage = (function () {
    function StatisticsPage(navCtrl, navParams, estatisticaProvider, storage) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.estatisticaProvider = estatisticaProvider;
    ...
    StatisticsPage.prototype.ionViewDidLoad = function () {
            ...
            if (res) {
                for (var property in res) {
                    if (res.hasOwnProperty(property)) {
                        _this.semestersYears.push(property);
                    }
                }
                _this.semesters = res;
            }
        });
        this.storage.get(__WEBPACK_IMPORTED_MODULE_0__utils_storage_keys__["a" /* StorageKeys */].STATISTIC).then(function (e) {
            if (e) {
                _this.estatistic = e;
                _this.showDoughnutChart();
                _this.showLineChart();
            }
        });
        this.estatisticaProvider.getEstatisticas()
            ...
            _this.estatistic = e;
            _this.storage.set(__WEBPACK_IMPORTED_MODULE_0__utils_storage_keys__["a" /* StorageKeys */].STATISTIC, e);
            _this.showDoughnutChart();
            _this.showLineChart();
        });
    };
    StatisticsPage.prototype.onPassoChanged = function () {
    };
    StatisticsPage.prototype.getSubjects = function (semester) {
        return this.semesters[semester].disciplinas;
    };
    StatisticsPage.prototype.showLineChart = function () {
    ...
    StatisticsPage.prototype.showDoughnutChart = function () {
    ...
    StatisticsPage.prototype.getClass = function (p) {
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_13" /* ViewChild */])('doughnutCanvas'),
    __metadata("design:type", Object)
], StatisticsPage.prototype, "doughnutCanvas", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_13" /* ViewChild */])('lineCanvas'),
    __metadata("design:type", Object)
], StatisticsPage.prototype, "lineCanvas", void 0);
StatisticsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'page-statistics',template:/*ion-inline-start:"/home/pedro/github/app/src/pages/statistics/statistics.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{ \'STATISTICS\' | translate }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <ion-segment [(ngModel)]="passo" (ionChange)="onPassoChanged()" color="main-color">\n    <ion-segment-button value="1">\n      Resumo\n    </ion-segment-button>\n    <ion-segment-button value="2">\n      Próximos semestres\n    </ion-segment-button>\n  </ion-segment>\n\n  <ion-list [ngClass]="getClass(\'1\')">\n      <canvas class="grafico-margin" #doughnutCanvas></canvas>\n  \n      <canvas class="grafico-margin" #lineCanvas></canvas>\n  </ion-list>\n\n  <ion-list [ngClass]="getClass(\'2\')">\n    <div *ngFor=\'let semester of semestersYears\'>\n        <p>{{ semester }}</p>\n        <subject-action-list [subjects]="getSubjects(semester)" [action]=false></subject-action-list>\n    </div>    \n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"/home/pedro/github/app/src/pages/statistics/statistics.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_5__providers_estatistica_estatistica__["a" /* EstatisticaProvider */],
...
Chart.helpers = __webpack_require__(308);

// @todo dispatch these helpers into appropriated helpers/helpers.* file and write unit tests!
__webpack_require__(466)(Chart);

Chart.defaults = __webpack_require__(309);
Chart.Element = __webpack_require__(312);
Chart.elements = __webpack_require__(321);
Chart.Interaction = __webpack_require__(328);
Chart.platform = __webpack_require__(329);
...
/* MIT license */
var colorNames = __webpack_require__(327);
...
var defaults = __webpack_require__(309);
var helpers = __webpack_require__(308);
var Interaction = __webpack_require__(328);
var platform = __webpack_require__(329);
...
var Element = __webpack_require__(312);
var helpers = __webpack_require__(308);
var Ticks = __webpack_require__(322);
...
var defaults = __webpack_require__(309);
var elements = __webpack_require__(321);
var helpers = __webpack_require__(308);
